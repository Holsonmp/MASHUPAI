	...
	function enableContactForm() {
		...
		$('#contact-form').on('submit', function(e) {
			...
			if (!e.isDefaultPrevented()) {
				var url = base_url + "home_controller/contact_post";
				...
				$.ajax({
					...
					success: function(data) {
						...
						var messageText = 'Votre message a été envoyé !';
						// let's compose Bootstrap alert box HTML
						var alertBox = '<div class="alert alert-success alert-dismissable"><button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button><h4><i class="icon fa fa-check"></i>Votre message a été envoyé!</h4></div>';
							// <div class="alert ' + messageAlert + ' alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + messageText + '</div>';
					
						// If we have messageAlert and messageText
						if (messageAlert && messageText) {
							// inject the alert to .messages div in our form
							$('#contact-form').find('.sec').html(alertBox);
							// empty the form
